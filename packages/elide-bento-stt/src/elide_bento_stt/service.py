...
from elide_bento_core.runtime import get_logger, request_id
from elide_bento_core.stt.v1 import SttRequest, SttResponse
from prometheus_client import Histogram

from elide_bento_stt.engine import SAMPLE_RATE, AudioTooLongError, Engine
...
image = (
    ...
    .requirements_file("packages/elide-bento-stt/requirements.txt")
)


@bentoml.service(
    name="elide-bento-stt",
    image=image,
    resources={"cpu": "4"},
