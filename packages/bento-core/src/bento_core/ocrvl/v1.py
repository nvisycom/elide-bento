...
leaner shape than the detection-OCR contract (``bento_core.ocr.v1``): the VLM
...
from bento_core.ocr.v1 import BlockKind, BoundingBox
from bento_core.types import Probability
